...
const BalanceSheet: React.FC = () => {
    ...
    const handleExportPdf = () => {
        exportToPdf('bs-report', `balance_sheet_${new Date().toISOString().split('T')[0]}`);
    };
    ...
    return (
        <div>
            ...
            <div id="bs-report" className="bg-white dark:bg-dark-secondary p-8 rounded-lg shadow-md printable-content">
