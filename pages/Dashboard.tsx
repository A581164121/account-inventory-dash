...
import { DollarSign, ShoppingCart, Briefcase, TrendingUp, BarChart, Package, PlusCircle, UserPlus, PackagePlus } from 'lucide-react';
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <Card title="Inventory Items" value={summary.inventoryItemsCount.toString()} icon={<Package size={24} className="text-white"/>} colorClass="bg-indigo-500" />
        </div>
